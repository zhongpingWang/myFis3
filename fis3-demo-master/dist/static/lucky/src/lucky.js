define('static/lucky/src/lucky', ['sea-modules/jquery/jquery/1.10.1/jquery', 'sea-modules/jquery/easing/1.3.0/easing', 'static/lucky/src/user'], function(require, exports, module) {

  var $ = require('sea-modules/jquery/jquery/1.10.1/jquery');
  require('sea-modules/jquery/easing/1.3.0/easing');

  var User = require('static/lucky/src/user');
